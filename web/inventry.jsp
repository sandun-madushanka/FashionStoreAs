        ...
        <div class="wrapper">
            <div class="sidebar" data-background-color="white" data-active-color="danger">
                ...
                <div class="sidebar-wrapper">
                    <div class="logo">
                        <a href="employee.jsp" class="simple-text">
                            Fashion Store
                        </a>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="iname" type="text" class="form-control border-input" required placeholder="item name">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Price per Item (Supplier Rate)</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Price per Item(Selling) : </label>
